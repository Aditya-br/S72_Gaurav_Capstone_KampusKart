            ...
            <form className="space-y-4 sm:space-y-5" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  type="text"
                  required
                  className={`w-full px-4 py-3 border-2 ${nameError ? 'border-red-400' : 'border-gray-200'
                    } rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00C6A7] focus:border-transparent bg-white text-gray-900 text-base placeholder:text-gray-400 transition-colors duration-200 min-h-touch`}
